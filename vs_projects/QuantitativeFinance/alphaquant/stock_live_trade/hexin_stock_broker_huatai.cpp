...
static std::string gen_second_packet(const std::string& account)
{
	unsigned char buff[] = {
		0xfd, 0xfd, /* @V...... */
		0xfd, 0xfd, 0x30, 0x30, 0x30, 0x30, 0x30, 0x32,
		0x66, 0x65, 0x00, 0xfd, 0xff, 0x00, 0x00, 0x00,
		...
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x40, 0xec, 0x33, 0x01, 0x01,
		0x00, 0x00, 0x00, 0x36, 0x36, 0x36, 0x36, 0x30,
		0x30, 0x30, 0x30, 0x31, 0x32, 0x33, 0x34, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		...
		                                           
	};
	time_t rawtime;
	struct tm * timeinfo;
...
int hexin_stock_broker_huatai::try_recv_packet(std::string& pkt)
{
...
hexin_stock_broker_huatai::hexin_stock_broker_huatai(const std::vector<boost::tuple<std::string, uint16_t>> &server_vec, const std::string& account, const std::string& password1, const std::string& password2, bool wait_response)
	:
...
hexin_stock_broker_huatai::~hexin_stock_broker_huatai()
{

}

std::string hexin_stock_broker_huatai::get_account()
{
...
int hexin_stock_broker_huatai::login()
{
	m_login = false;
	try {
...
void hexin_stock_broker_huatai::logout()
{
	m_login = false;
...
std::string hexin_stock_broker_huatai::create_order(const std::string& operation, const std::string& direction, const std::string& sid, double price, int amount)
{
	order_state ostate;
...
void hexin_stock_broker_huatai::buy(const std::string& sid, double price, int quant, const std::string& price_type, const std::string& user_order_id)
{
	bool found = false;
	do {
		ScopedLock lck(m_critical_sec);
...
int hexin_stock_broker_huatai::handle_buy_response(const std::string& resp)
{
	std::string msg;
...
void hexin_stock_broker_huatai::sell(const std::string& sid, double price, int quant, const std::string& price_type, const std::string& user_order_id)
{
	bool found = false;
	do {
		ScopedLock lck(m_critical_sec);
...
order_state hexin_stock_broker_huatai::get_order_state(const std::string& user_order_id)
{
	ScopedLock lck(m_critical_sec);
...
int hexin_stock_broker_huatai::handle_sell_response(const std::string& resp)
{
	std::string msg;
	uint32_t packet_index;
...
void hexin_stock_broker_huatai::cancel_order(const std::string& user_order_id)
{
	std::string internal_order_id;
	std::string sid;
	do {
...
int hexin_stock_broker_huatai::handle_cancel_response(const std::string& resp)
{
	std::string msg;
...
int hexin_stock_broker_huatai::handle_deal_notification(const std::string& resp)
{	
...
std::vector<order_state> hexin_stock_broker_huatai::get_all_order()
{
	ScopedLock lck(m_critical_sec);
...
int hexin_stock_broker_huatai::handle_all_order_response(const std::string& resp)
{
	bool success;
...
std::vector<holding_item> hexin_stock_broker_huatai::get_holding_stock()
{
	ScopedLock lck(m_critical_sec);
...
int hexin_stock_broker_huatai::handle_get_holding_response(const std::string& resp)
{
...
std::vector<double> hexin_stock_broker_huatai::get_money_left()
{
...
int hexin_stock_broker_huatai::handle_get_balance_response(const std::string& resp)
{
...
int hexin_stock_broker_huatai::handle_packet(const std::string& pkt)
{
	if (pkt.size() == 4) {
		return 0;
	}
...
int hexin_stock_broker_huatai::update_account()
{
...
int hexin_stock_broker_huatai::send_login_packet()
{
...
int hexin_stock_broker_huatai::send_get_gddm_packet()
{
	//query gddm, pkt3
...
int hexin_stock_broker_huatai::send_get_account_holding()
{
...
int hexin_stock_broker_huatai::send_get_account_balance()
{
...
int hexin_stock_broker_huatai::send_get_account_all_order()
{
...
int hexin_stock_broker_huatai::send_buy(const std::string& sid, double price, int quant, const std::string& price_type)
{
	std::string gddm;
	char market = 0;
...
int hexin_stock_broker_huatai::send_sell(const std::string& sid, double price, int quant, const std::string& price_type)
{
	std::string gddm;
	char market = 0;
...
int hexin_stock_broker_huatai::send_cancel(const std::string& order_id, const std::string& sid)
{
	std::string gddm;
	char market = 0;
