...
class hexin_stock_broker : public stock_broker
{
public:
	hexin_stock_broker(const std::vector<boost::tuple<std::string, uint16_t>> &server_vec, const std::string& account, const std::string& password1, const std::string& password2, bool wait_response);
	virtual ~hexin_stock_broker();
