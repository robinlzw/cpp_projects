...
{
    char const *lzw_str_array1[] =  {"000001K", "000002J", "000012J", "000001K", "000002J", "000012J"};
    char const *lzw_str_array2[] =  {"20100310", "20100311", "20100311", "20100310", "20100311", "20100311"};
    if( doDraw == 1 )
        DrawFSJL(const_cast<char*>(lzw_str_array1[0]),const_cast<char*>(lzw_str_array2[0]));
    else if( doDraw == 2 )
        DrawFSJL(const_cast<char*>(lzw_str_array1[1]),const_cast<char*>(lzw_str_array2[1]));
    else if( doDraw == 3 )
        DrawFSJL(const_cast<char*>(lzw_str_array1[2]),const_cast<char*>(lzw_str_array2[2]));
    else if( doDraw == 4 )
        DrawFSJL(const_cast<char*>(lzw_str_array1[3]),const_cast<char*>(lzw_str_array2[3]));
    else if( doDraw == 5 )
        DrawFSJL(const_cast<char*>(lzw_str_array1[4]),const_cast<char*>(lzw_str_array2[4]));
    else if( doDraw == 6 )
        DrawFSJL(const_cast<char*>(lzw_str_array1[5]),const_cast<char*>(lzw_str_array2[5]));
    else if( doDraw == 7 )
        DrawBK();
        DrawLines();
        //drawShape();
